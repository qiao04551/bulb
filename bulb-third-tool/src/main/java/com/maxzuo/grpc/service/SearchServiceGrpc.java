...
@javax.annotation.Generated(
    ...
    comments = "Source: grpc-invoke.proto")
public final class SearchServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.maxzuo.grpc.protocol.SearchRequest,
      com.maxzuo.grpc.protocol.SearchResponse> getSearchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "search",
      requestType = com.maxzuo.grpc.protocol.SearchRequest.class,
      responseType = com.maxzuo.grpc.protocol.SearchResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.maxzuo.grpc.protocol.SearchRequest,
      com.maxzuo.grpc.protocol.SearchResponse> getSearchMethod() {
    io.grpc.MethodDescriptor<com.maxzuo.grpc.protocol.SearchRequest, com.maxzuo.grpc.protocol.SearchResponse> getSearchMethod;
      ...
      synchronized (SearchServiceGrpc.class) {
        if ((getSearchMethod = SearchServiceGrpc.getSearchMethod) == null) {
          SearchServiceGrpc.getSearchMethod = getSearchMethod =
              io.grpc.MethodDescriptor.<com.maxzuo.grpc.protocol.SearchRequest, com.maxzuo.grpc.protocol.SearchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "search"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.maxzuo.grpc.protocol.SearchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.maxzuo.grpc.protocol.SearchResponse.getDefaultInstance()))
  ...
  public static abstract class SearchServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void search(com.maxzuo.grpc.protocol.SearchRequest request,
        io.grpc.stub.StreamObserver<com.maxzuo.grpc.protocol.SearchResponse> responseObserver) {
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.maxzuo.grpc.protocol.SearchRequest,
                com.maxzuo.grpc.protocol.SearchResponse>(
  ...
  public static final class SearchServiceBlockingStub extends io.grpc.stub.AbstractStub<SearchServiceBlockingStub> {
    ...
    /**
     */
    public com.maxzuo.grpc.protocol.SearchResponse search(com.maxzuo.grpc.protocol.SearchRequest request) {
  ...
  public static final class SearchServiceFutureStub extends io.grpc.stub.AbstractStub<SearchServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.maxzuo.grpc.protocol.SearchResponse> search(
        com.maxzuo.grpc.protocol.SearchRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEARCH:
          serviceImpl.search((com.maxzuo.grpc.protocol.SearchRequest) request,
              (io.grpc.stub.StreamObserver<com.maxzuo.grpc.protocol.SearchResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SearchServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.maxzuo.grpc.protocol.NetworkProtocol.getDescriptor();
    }
